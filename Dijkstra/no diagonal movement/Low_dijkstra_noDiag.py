...
img = cv.imread('/home/ramona/Desktop/IIT KGP/AGV/Software/Task 1/Task_1_Low.png', 1)
...
stop = time.time()
timeOfProgram2 = stop - begin
print("Run time of program implementing Dijkstra is:", timeOfProgram2)

cv.imshow('output image', img)
cv.waitKey(0)
cv.destroyAllWindows()
cv.imwrite('/home/ramona/Desktop/IIT KGP/AGV/Software/Task 1/Task_1_Low_ds_result.png', img)