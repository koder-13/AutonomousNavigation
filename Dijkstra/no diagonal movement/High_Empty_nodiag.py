...
img = cv.imread('/home/ramona/Desktop/IIT KGP/AGV/Software/Task 1/Task_1_High_Empty.png', 1)
...
stop = time.time()
timeOfProgram4 = stop - begin
print("Run time of program implementing Dijkstra is:", timeOfProgram4)

cv.imshow('new_image', img)
cv.waitKey(0)
cv.destroyAllWindows()
cv.imwrite('/home/ramona/Desktop/IIT KGP/AGV/Software/Task 1/Task_1_High_Empty_ds_result.png', img)