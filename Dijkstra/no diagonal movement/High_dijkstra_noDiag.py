...
img = cv.imread('/home/ramona/Desktop/IIT KGP/AGV/Software/Task 1/Task_1_High.png', 1)
...
stop = time.time()
timeOfProgram1 = stop - begin
print("Run time of program implementing Dijkstra is:", timeOfProgram1)

cv.imshow('new_image', img)
cv.waitKey(0)
cv.destroyAllWindows()
cv.imwrite('/home/ramona/Desktop/IIT KGP/AGV/Software/Task 1/Task_1_High_ds_result.png', img)